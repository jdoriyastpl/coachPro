    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.PositiveIntegerField(validators=[django.core.validators.RegexValidator(code='invalid_phone_number', message='Phone Number should be valid of 10 digits only', regex='^(\\+91[\\-\\s]?)?[0]?(91)?[789]\\d{9}$')])),
