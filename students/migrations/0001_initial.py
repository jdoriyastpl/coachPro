# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-08-26 23:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course', to='courses.Courses')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_Id', models.CharField(default='STU20178RPSB3U', max_length=200)),
                ('created_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('subject', models.CharField(max_length=150)),
                ('phone_number', models.PositiveIntegerField(validators=[django.core.validators.RegexValidator(code='invalid_phone_number', message='Phone Number should be valid of 10 digits only', regex='^(\\+91[\\-\\s]?)?[0]?(91)?[789]\\d{9}$')])),
                ...
                ('adhaar_number', models.CharField(blank=True, max_length=255)),
